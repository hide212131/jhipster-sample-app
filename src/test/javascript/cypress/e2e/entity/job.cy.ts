...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Global Applications Facilitator');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'Global Applications Facilitator');

      cy.get(`[data-cy="minSalary"]`).type('20413');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '20413');

      cy.get(`[data-cy="maxSalary"]`).type('25653');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '25653');
