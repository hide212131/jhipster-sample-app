...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Direct Applications Officer');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'Direct Applications Officer');

      cy.get(`[data-cy="minSalary"]`).type('5564');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '5564');

      cy.get(`[data-cy="maxSalary"]`).type('16583');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '16583');
