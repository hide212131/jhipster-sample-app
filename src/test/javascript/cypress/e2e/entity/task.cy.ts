...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('qua gadzooks');
      cy.get(`[data-cy="title"]`).should('have.value', 'qua gadzooks');

      cy.get(`[data-cy="description"]`).type('than save hence');
      cy.get(`[data-cy="description"]`).should('have.value', 'than save hence');
