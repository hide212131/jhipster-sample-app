...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('joyously category');
      cy.get(`[data-cy="title"]`).should('have.value', 'joyously category');

      cy.get(`[data-cy="description"]`).type('indication whenever aside');
      cy.get(`[data-cy="description"]`).should('have.value', 'indication whenever aside');
