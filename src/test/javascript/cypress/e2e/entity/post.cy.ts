...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'so', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2023-09-17T10:35:23.774Z' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('besides round delectable');
      cy.get(`[data-cy="title"]`).should('have.value', 'besides round delectable');
      ...
      cy.get(`[data-cy="date"]`).type('2023-09-17T05:16');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2023-09-17T05:16');
