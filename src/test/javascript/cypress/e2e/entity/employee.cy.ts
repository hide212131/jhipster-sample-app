...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('健太郎');
      cy.get(`[data-cy="firstName"]`).should('have.value', '健太郎');

      cy.get(`[data-cy="lastName"]`).type('中村');
      cy.get(`[data-cy="lastName"]`).should('have.value', '中村');

      cy.get(`[data-cy="email"]`).type('rryi1c_i6nkgn79@hotmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'rryi1c_i6nkgn79@hotmail.com');

      cy.get(`[data-cy="phoneNumber"]`).type('feature solemnly minus');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'feature solemnly minus');

      cy.get(`[data-cy="hireDate"]`).type('2023-11-21T03:14');
      cy.get(`[data-cy="hireDate"]`).blur();
      cy.get(`[data-cy="hireDate"]`).should('have.value', '2023-11-21T03:14');

      cy.get(`[data-cy="salary"]`).type('25333');
      cy.get(`[data-cy="salary"]`).should('have.value', '25333');

      cy.get(`[data-cy="commissionPct"]`).type('7779');
      cy.get(`[data-cy="commissionPct"]`).should('have.value', '7779');
