...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('Norma');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Norma');

      cy.get(`[data-cy="lastName"]`).type('Berge');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Berge');

      cy.get(`[data-cy="email"]`).type('Mollie_Medhurst6@yahoo.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Mollie_Medhurst6@yahoo.com');

      cy.get(`[data-cy="phoneNumber"]`).type('endow');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'endow');

      cy.get(`[data-cy="hireDate"]`).type('2023-09-24T07:50');
      cy.get(`[data-cy="hireDate"]`).blur();
      cy.get(`[data-cy="hireDate"]`).should('have.value', '2023-09-24T07:50');

      cy.get(`[data-cy="salary"]`).type('27598');
      cy.get(`[data-cy="salary"]`).should('have.value', '27598');

      cy.get(`[data-cy="commissionPct"]`).type('4577');
      cy.get(`[data-cy="commissionPct"]`).should('have.value', '4577');
