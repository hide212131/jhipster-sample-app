...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      cy.get(`[data-cy="streetAddress"]`).type('uh-huh');
      cy.get(`[data-cy="streetAddress"]`).should('have.value', 'uh-huh');

      cy.get(`[data-cy="postalCode"]`).type('how');
      cy.get(`[data-cy="postalCode"]`).should('have.value', 'how');

      cy.get(`[data-cy="city"]`).type('Bedford');
      cy.get(`[data-cy="city"]`).should('have.value', 'Bedford');

      cy.get(`[data-cy="stateProvince"]`).type('aw');
      cy.get(`[data-cy="stateProvince"]`).should('have.value', 'aw');
