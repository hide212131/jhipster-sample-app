...
describe('Department e2e test', () => {
  ...
  const departmentSample = { departmentName: 'because yowza' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="departmentName"]`).type('meanwhile sycamore');
      cy.get(`[data-cy="departmentName"]`).should('have.value', 'meanwhile sycamore');
