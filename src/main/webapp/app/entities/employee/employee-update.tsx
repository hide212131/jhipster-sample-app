  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="myApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('myApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('myApp.employee.lastName')}
                id="employee-lastName"
                name="lastName"
                data-cy="lastName"
                type="text"
              />
              <ValidatedField label={translate('myApp.employee.email')} id="employee-email" name="email" data-cy="email" type="text" />
              <ValidatedField
                label={translate('myApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('myApp.employee.hireDate')}
              ...
              />
              <ValidatedField label={translate('myApp.employee.salary')} id="employee-salary" name="salary" data-cy="salary" type="text" />
              <ValidatedField
                label={translate('myApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('myApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('myApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
