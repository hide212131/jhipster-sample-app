    ...
    <Row>
      <Col md="8">
        <h2 data-cy="blogDetailsHeading">
          <Translate contentKey="myReactApp.blog.detail.title">Blog</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="myReactApp.blog.name">Name</Translate>
            </span>
          </dt>
          ...
          <dt>
            <Translate contentKey="myReactApp.blog.user">User</Translate>
          </dt>
