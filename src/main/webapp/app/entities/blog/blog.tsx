  ...
  return (
    <div>
      <h2 id="blog-heading" data-cy="BlogHeading">
        <Translate contentKey="myReactApp.blog.home.title">Blogs</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="myReactApp.blog.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/blog/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="myReactApp.blog.home.createLabel">Create new Blog</Translate>
          </Link>
        </div>
      </h2>
        ...
        {blogList && blogList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="myReactApp.blog.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="myReactApp.blog.name">Name</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('name')} />
                </th>
                <th className="hand" onClick={sort('handle')}>
                  <Translate contentKey="myReactApp.blog.handle">Handle</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('handle')} />
                </th>
                <th>
                  <Translate contentKey="myReactApp.blog.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="myReactApp.blog.home.notFound">No Blogs found</Translate>
            </div>
          )
        )}
      </div>
