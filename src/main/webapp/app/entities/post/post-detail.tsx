    ...
    <Row>
      <Col md="8">
        <h2 data-cy="postDetailsHeading">
          <Translate contentKey="myReactApp.post.detail.title">Post</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="date">
              <Translate contentKey="myReactApp.post.date">Date</Translate>
            </span>
          </dt>
          <dd>{postEntity.date ? <TextFormat value={postEntity.date} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <Translate contentKey="myReactApp.post.blog">Blog</Translate>
          </dt>
          <dd>{postEntity.blog ? postEntity.blog.name : ''}</dd>
          <dt>
            <Translate contentKey="myReactApp.post.tag">Tag</Translate>
          </dt>
          <dd>
            {postEntity.tags
