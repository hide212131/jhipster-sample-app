  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="myApp.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('myApp.location.streetAddress')}
              ...
              />
              <ValidatedField
                label={translate('myApp.location.postalCode')}
                id="location-postalCode"
                name="postalCode"
                data-cy="postalCode"
                type="text"
              />
              <ValidatedField label={translate('myApp.location.city')} id="location-city" name="city" data-cy="city" type="text" />
              <ValidatedField
                label={translate('myApp.location.stateProvince')}
              ...
              <ValidatedField
                ...
                name="country"
                data-cy="country"
                label={translate('myApp.location.country')}
                type="select"
              >
                <option value="" key="0" />
                {countries
