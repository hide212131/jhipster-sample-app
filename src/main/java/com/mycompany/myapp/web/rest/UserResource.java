...
public class UserResource {
    ...
    @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.ADMIN + "\")")
    public ResponseEntity<AdminUserDTO> getUser(@PathVariable(name = "login") @Pattern(regexp = Constants.LOGIN_REGEX) String login) {
    ...
    @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.ADMIN + "\")")
    public ResponseEntity<Void> deleteUser(@PathVariable(name = "login") @Pattern(regexp = Constants.LOGIN_REGEX) String login) {
